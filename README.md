...
Чтобы запустить с альтернативной конфигурацией, запускаейте liberty-pre с аргументом `-c config_name.cfg`  
...
Драйвер WinDivert не вирус, читайте [подробности](https://github.com/bol-van/zapret-win-bundle?tab=readme-ov-file#антивирусы) почему антивирусы иногда ругаются и почему так происходит.
